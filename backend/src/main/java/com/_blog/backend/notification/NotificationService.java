...
public class NotificationService {
    ...
    public void createCommentNotification(UUID postId, String actorUsername) {
        ...
        Notification notification = Notification.builder()
            ...
            .postId(postId)
            .message(actor.getFirstName() + " " + actor.getLastName() + " commented on your post \"" + post.getTitle() + "\"")
            .createdAt(LocalDateTime.now())
            .isRead(false)
            .build();
    ...
    public void createNewPostNotification(Post post) {
        ...
        for (User follower : followers) {
            Notification notification = Notification.builder()
                ...
                .postId(post.getId())
                .message(author.getFirstName() + " " + author.getLastName() + " published a new post: \"" + post.getTitle() + "\"")
                .createdAt(LocalDateTime.now())
                .isRead(false)
                .build();
